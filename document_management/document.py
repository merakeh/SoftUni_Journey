...
class Document:
    def __init__(self, id_num: int, category_id: int, topic_id: int, file_name: str):
        self.id = id_num
    ...
    @classmethod
    def from_instances(cls, id_num: int, category: Category, topic: Topic, file_name: str):
        return cls(id_num, category.id, topic.id, file_name)
